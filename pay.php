...
<body id="top">
    ...
    <div class="topnav">
        ...
        <div class="topnav-right">
            <a href="payEN.php" align="right">TH|EN</a>
        </div>
    </div>
    <br>
    <center>
...
<font size="10px"> ยอดรวมทั้งหมด : </font>
<span class="fw-bold"> <font size="10px"><?= $total_cost ?> </font></span>
<font size="10px"> บาท </font>

    <br>
    <font size="5px"color="red">แสกนแล้วกดยืนยัน !! </font>
    <br>
    <br>
    <button class="custom-button"
    onclick="document.location='order.php'">BACK</button>
    <button class="custom-button"onclick="document.location='wait.php'">NEXT</button>
</body>
