...
<body id="top">
    ...
    <div class="topnav">
        ...
        <a href="order.php?i=1">MENU</a>
        <div class="topnav-right">
            <a href="waitEN.php" align="right">TH|EN</a>
        </div>
    </div>
    ...
    <center>
        ...
        กรุณาเรียกพนักงาน
        <br>
        <button class="custom-button" onclick="document.location='home.php'">HOME</button>
        <button class="custom-button" onclick="document.location='order.php'">MORE</button>
